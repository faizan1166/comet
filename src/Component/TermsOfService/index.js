          ...
          <div className=" h-100" style={{ background: "rgb(0 0 0 / 58%)" }}>
            <div className="d-flex h-100 text-center align-items-center">
              <div className="w-100 text-white">
                <h1 className="display-3 text-white">TERMS OF SERVICE</h1>
                <p className="text-white fs-4">Last updated : June 13, 2022</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container terms">
        <div className="row fs-6 mb-5">
          ...
          <div className="col-md-12 mt-4">
            ...
            and Your Land Loans, LLC (" Company ", “we”, “us”, or “our”),
            concerning your access to and use of the yourlandloans.com website
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">SUBMISSIONS</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">SITE MANAGEMENT</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">PRIVACY POLICY</div>
          <div className="col-md-12 mt-4">
            We care about data privacy and security. Please review our Privacy
            Policy: yourlandloans.com/privacy.html. By using the Site, you agree
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">GOVERNING LAW</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-4 fw-semibold">
          ...
          <div className="col-md-12 mt-3">
            ...
            state and federal courts located in Maricopa , Arizona , and the
          ...
          <div className="col-md-12 fs-4 mt-4 fw-semibold">Restrictions</div>
          <div className="col-md-12 mt-2">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">CORRECTIONS</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">DISCLAIMER</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">INDEMNIFICATION</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">USER DATA</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">
            DWOLLA PAYMENT SYSTEMS
          </div>
          <div className="col-md-12 mt-4">
            In order to use the payment functionality of our application, you
            must open a “Dwolla Platform” account provided by Dwolla, Inc. and
            you must accept the{" "}
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">LOAN DETAILS</div>
          <div className="col-md-12 mt-4">
            You agree that any and all loans serviced or supported through this
            platform have been created and fully originated before being managed
            hereon. Further, you agree that the designated loan servicer for
            each loan on the platform is you and not us or any of our
            representatives. We are not a loan servicer nor can we guarantee
            compliance with any and all regulatory frameworks in all
            jurisdictions. You agree that you are responsible for any and all
            regulatory compliance in any jurisdiction you may operate in.
            Additionally, you agree that this platform will be used exclusively
            for loans where the borrower does not occupy the property, including
            as a primary residence.
          </div>

          <div className="col-md-12 fs-4 mt-5 fw-semibold">MISCELLANEOUS</div>
          <div className="col-md-12 mt-4">
          ...
          <div className="col-md-12 fs-4 mt-5 fw-semibold">CONTACT US</div>
          <div className="col-md-12 mt-4">
            In order to resolve a complaint regarding the Site or to receive
            further information regarding use of the Site, please contact us at:
          </div>
          <div className="col-md-12 mt-4  fw-semibold">
            Your Land Loans, LLC
            <br />
            ...
            United States
            <br />
            <a href="mailto:TOS@yourlandloans.com">
              contact@yourlandloans.com
            </a>
          </div>
        </div>
      </div>
